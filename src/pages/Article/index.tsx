...
const ArticleData = {
	imgUrl:
		'https://images.unsplash.com/photo-1546557036-57b741df8f5a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8bGl6emFyZHxlbnwwfHwwfHw%3D&w=1000&q=80',
	...
	return (
		<>
			<Box className='background'>
				<img className='img' src={ArticleData.imgUrl} alt='' />
			</Box>
